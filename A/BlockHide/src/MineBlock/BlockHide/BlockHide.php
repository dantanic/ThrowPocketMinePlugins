...
class BlockHide extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->bh = (new Config($this->getDataFolder() . "BlockHide.yml", Config::YAML, ["Time" => 60, "Pos" => false, "TaggerPos" => "128:1000:128", "World" => false, "Protect" => false, "Item" => ["Tagger" => ["310:0:1", "311:0:1", "312:0:1", "313:0:1", "276:0:1"], "Player" => ["332:0:255", "298:0:1", "299:0:1", "300:0:1", "301:0:1"]]]))->getAll();
	}

	public function saveYml(){
		$bh = new Config($this->getDataFolder() . "BlockHide.yml", Config::YAML);
		$bh->setAll($this->bh);
		$bh->save();
	}
	...
	public function isKorean(){
		@mkdir($this->getDataFolder());
		if(!isset($this->ik)) $this->ik = (new Config($this->getDataFolder() . "! Korean.yml", Config::YAML, ["Korean" => true]))->get("Korean");
		return $this->ik;
	}
